...
<TextField className='bg-gray-400 hover:bg-white place-content-center bg-blend-color' label="FirstName"
          id="outlined-size-small"
          defaultValue="Name"
          margin="dense"
          color="info"
          size="small"  />
          <input className='placeholder:text-xs active:!border-[#4c9aff] focus:!border-2 ' />
